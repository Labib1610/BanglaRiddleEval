#!/usr/bin/env python3
"""
Runner script for Gemma3:4b Semantic Ambiguity evaluation
"""
...
def main():
    print("🎯 Bengali Riddle Semantic Ambiguity Evaluation - Gemma3:4b")
    print("=" * 65)
    ...
    try:
        ...
        from gemma3_4b import main as eval_main
        eval_main()
