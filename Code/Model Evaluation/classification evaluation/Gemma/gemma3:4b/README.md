# Gemma3:4b Semantic Ambiguity Evaluation

This directory contains the evaluation pipeline for testing the Gemma3:4b model on Bengali riddle semantic ambiguity questions.
...
- `gemma3_4b.py` - Main evaluation script
...
Edit the CONFIG section in `gemma3_4b.py`:
...
- `riddles_semantic_ambiguity_gemma3_4b_zero.json` - Zero-shot results
- `riddles_semantic_ambiguity_gemma3_4b_few.json` - Few-shot results  
- `riddles_semantic_ambiguity_gemma3_4b_cot.json` - CoT results
- `riddles_semantic_ambiguity_metrics_gemma3_4b_zero.json` - Zero-shot metrics
- `riddles_semantic_ambiguity_metrics_gemma3_4b_few.json` - Few-shot metrics
- `riddles_semantic_ambiguity_metrics_gemma3_4b_cot.json` - CoT metrics
