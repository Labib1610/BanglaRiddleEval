# Gemma3:12b Semantic Ambiguity Evaluation

This directory contains the evaluation pipeline for testing the Gemma3:12b model on Bengali riddle semantic ambiguity questions.
...
- `gemma3_12b.py` - Main evaluation script
...
python gemma3_12b.py
```

### Configuration

Edit the CONFIG section in `gemma3_12b.py`:
...
- `riddles_semantic_ambiguity_gemma3_12b_zero.json` - Zero-shot results
- `riddles_semantic_ambiguity_gemma3_12b_few.json` - Few-shot results  
- `riddles_semantic_ambiguity_gemma3_12b_cot.json` - CoT results
- `riddles_semantic_ambiguity_metrics_gemma3_12b_zero.json` - Zero-shot metrics
- `riddles_semantic_ambiguity_metrics_gemma3_12b_few.json` - Few-shot metrics
- `riddles_semantic_ambiguity_metrics_gemma3_12b_cot.json` - CoT metrics
