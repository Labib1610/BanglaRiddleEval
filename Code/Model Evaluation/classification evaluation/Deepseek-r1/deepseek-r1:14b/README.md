# DeepSeek R1 14B Semantic Ambiguity Evaluation

This directory contains the evaluation pipeline for testing the DeepSeek R1 14B model on Bengali riddle semantic ambiguity questions.
...
- `deepseek_r1_14b.py` - Main evaluation script
- `run_evaluation.py` - Simple runner script (legacy)
- `test_dataset.py` - Dataset loading test script (legacy)
...
python deepseek_r1_14b.py
```

### Configuration

Edit the CONFIG section in `deepseek_r1_14b.py`:
...
- `riddles_semantic_ambiguity_deepseek_r1_14b_zero.json` - Zero-shot results
- `riddles_semantic_ambiguity_deepseek_r1_14b_few.json` - Few-shot results  
- `riddles_semantic_ambiguity_deepseek_r1_14b_cot.json` - CoT results
- `riddles_semantic_ambiguity_metrics_deepseek_r1_14b_zero.json` - Zero-shot metrics
- `riddles_semantic_ambiguity_metrics_deepseek_r1_14b_few.json` - Few-shot metrics
- `riddles_semantic_ambiguity_metrics_deepseek_r1_14b_cot.json` - CoT metrics
