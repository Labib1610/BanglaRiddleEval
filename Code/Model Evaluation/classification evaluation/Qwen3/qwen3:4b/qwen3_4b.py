...
Semantic Ambiguity evaluation pipeline for Bengali riddles using Ollama qwen3:4b model.
...
OUTPUT_ROOT = Path("/mnt/wwn-0x500a0751e14d807e-part2/Labib/Labib Folder/Labib/Research/BornoDhada/Code/Model Evaluation (Benchmark)/classification evaluation/Qwen3/qwen3:4b")
...
def process_mcq_evaluation(ollama_llm: OllamaLLM, prompt_mode="few", n_examples=None):
    ...
    out_file = OUTPUT_ROOT / f"riddles_semantic_ambiguity_qwen3_4b_{prompt_mode}.json"
    ...
    if not examples_to_process:
        ...
        metrics_out = OUTPUT_ROOT / f"riddles_semantic_ambiguity_metrics_qwen3_4b_{prompt_mode}.json"
