# Qwen3:4b Semantic Ambiguity Evaluation

This directory contains the evaluation pipeline for testing the Qwen3:4b model on Bengali riddle semantic ambiguity questions.
...
- `qwen3_4b.py` - Main evaluation script
...
Edit the CONFIG section in `qwen3_4b.py`:

```python
MODEL_NAME = "qwen2.5:4b"         # Ollama model name
...
- `riddles_semantic_ambiguity_qwen3_4b_zero.json` - Zero-shot results
- `riddles_semantic_ambiguity_qwen3_4b_few.json` - Few-shot results  
- `riddles_semantic_ambiguity_qwen3_4b_cot.json` - CoT results
- `riddles_semantic_ambiguity_metrics_qwen3_4b_zero.json` - Zero-shot metrics
- `riddles_semantic_ambiguity_metrics_qwen3_4b_few.json` - Few-shot metrics
- `riddles_semantic_ambiguity_metrics_qwen3_4b_cot.json` - CoT metrics
