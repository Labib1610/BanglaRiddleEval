# Qwen3:14b Semantic Ambiguity Evaluation

This directory contains the evaluation pipeline for testing the Qwen3:14b model on Bengali riddle semantic ambiguity questions.
...
- `riddles_semantic_ambiguity_qwen3_14b_zero.json` - Zero-shot results
- `riddles_semantic_ambiguity_qwen3_14b_few.json` - Few-shot results  
- `riddles_semantic_ambiguity_qwen3_14b_cot.json` - CoT results
- `riddles_semantic_ambiguity_metrics_qwen3_14b_zero.json` - Zero-shot metrics
- `riddles_semantic_ambiguity_metrics_qwen3_14b_few.json` - Few-shot metrics
- `riddles_semantic_ambiguity_metrics_qwen3_14b_cot.json` - CoT metrics
