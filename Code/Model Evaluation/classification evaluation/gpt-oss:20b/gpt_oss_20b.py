...
Semantic Ambiguity evaluation pipeline for Bengali riddles using Ollama gpt-oss:20b model.
...
OUTPUT_ROOT = Path("/mnt/wwn-0x500a0751e14d807e-part2/Labib/Labib Folder/Labib/Research/BornoDhada/Code/Model Evaluation (Benchmark)/classification evaluation/gpt-oss:20b")
OUTPUT_ROOT.mkdir(parents=True, exist_ok=True)

MCQ_DATASET_PATH = Path("/mnt/wwn-0x500a0751e14d807e-part2/Labib/Labib Folder/Labib/Research/BornoDhada/main_dataset/riddles_semantic_ambiguity.json")
...
def process_mcq_evaluation(ollama_llm: OllamaLLM, prompt_mode="few", n_examples=None):
    ...
    out_file = OUTPUT_ROOT / f"riddles_semantic_ambiguity_gpt_oss_20b_{prompt_mode}.json"
    ...
    if not examples_to_process:
        ...
        metrics_out = OUTPUT_ROOT / f"riddles_semantic_ambiguity_metrics_gpt_oss_20b_{prompt_mode}.json"
