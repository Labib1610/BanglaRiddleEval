# GPT-OSS:20b Semantic Ambiguity Evaluation

This directory contains the evaluation pipeline for testing the GPT-OSS:20b model on Bengali riddle semantic ambiguity questions.
...
- `gpt_oss_20b.py` - Main evaluation script
...
Edit the CONFIG section in `gpt_oss_20b.py`:
...
- `riddles_semantic_ambiguity_gpt_oss_20b_zero.json` - Zero-shot results
- `riddles_semantic_ambiguity_gpt_oss_20b_few.json` - Few-shot results  
- `riddles_semantic_ambiguity_gpt_oss_20b_cot.json` - CoT results
- `riddles_semantic_ambiguity_metrics_gpt_oss_20b_zero.json` - Zero-shot metrics
- `riddles_semantic_ambiguity_metrics_gpt_oss_20b_few.json` - Few-shot metrics
- `riddles_semantic_ambiguity_metrics_gpt_oss_20b_cot.json` - CoT metrics
