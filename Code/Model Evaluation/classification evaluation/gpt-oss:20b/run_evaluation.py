#!/usr/bin/env python3
"""
Runner script for GPT-OSS:20b Semantic Ambiguity evaluation
"""
...
def main():
    print("🎯 Bengali Riddle Semantic Ambiguity Evaluation - GPT-OSS:20b")
    print("=" * 65)
    ...
    try:
        ...
        from gpt_oss_20b import main as eval_main
        eval_main()
