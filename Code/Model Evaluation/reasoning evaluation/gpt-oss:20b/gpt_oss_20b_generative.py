...
Reasoning evaluation pipeline for Bengali riddles using Ollama gpt-oss:20b model.
...
OUTPUT_ROOT = Path("/mnt/wwn-0x500a0751e14d807e-part2/Labib/Labib Folder/Labib/Research/BornoDhada/Code/Model Evaluation (Benchmark)/reasoning evaluation/gpt-oss:20b")
...
def process_generative_evaluation(ollama_llm: OllamaLLM, gemini_judge: RotatingGeminiClient, prompt_mode="zero_shot"):
    ...
    out_file = OUTPUT_ROOT / f"riddles_reasoning_gpt_oss_20b_{prompt_mode}{suffix}.json"
    ...
    if not remaining_data:
        ...
        metrics_out = OUTPUT_ROOT / f"riddles_reasoning_metrics_gpt_oss_20b_{prompt_mode}{suffix}.json"
