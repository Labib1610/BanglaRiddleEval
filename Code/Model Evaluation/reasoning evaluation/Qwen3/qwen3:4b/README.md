# Qwen3:4b Reasoning Evaluation Suite

This directory contains reasoning evaluation pipeline for testing the Qwen3:4b model on Bengali riddle reasoning generation.
...
- `qwen3_4b_generative.py` - Reasoning evaluation script with LLM judge (Note: filename is a misnomer, this is for reasoning)
- `run_generative_evaluation.py` - Reasoning runner script (Note: filename is a misnomer, this is for reasoning)
...
# Or run directly
python qwen3_4b_generative.py
```

### Configuration

Edit the CONFIG section in `qwen3_4b_generative.py`:

```python
MODEL_NAME = "qwen3:4b"     # Ollama model name
...
- `riddles_reasoning_qwen3_4b_zero_shot_sample150.json` - Zero-shot results
- `riddles_reasoning_qwen3_4b_few_shot_sample150.json` - Few-shot results  
- `riddles_reasoning_qwen3_4b_chain_of_thought_sample150.json` - CoT results
- `riddles_reasoning_metrics_qwen3_4b_zero_shot_sample150.json` - Zero-shot metrics
- `riddles_reasoning_metrics_qwen3_4b_few_shot_sample150.json` - Few-shot metrics
- `riddles_reasoning_metrics_qwen3_4b_chain_of_thought_sample150.json` - CoT metrics
