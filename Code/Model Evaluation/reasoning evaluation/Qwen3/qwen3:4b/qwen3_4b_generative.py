#!/usr/bin/env python3
"""
qwen3_4b_generative.py

Reasoning evaluation pipeline for Bengali riddles using Ollama qwen3:4b model.
...
OUTPUT_ROOT = Path("/mnt/wwn-0x500a0751e14d807e-part2/Labib/Labib Folder/Labib/Research/BornoDhada/Code/Model Evaluation (Benchmark)/reasoning evaluation/Qwen3/qwen3:4b")
...
def main():
    ...
    print("🎯 Bengali Riddle Reasoning Evaluation - Qwen3:4b")
    print("=" * 60)
