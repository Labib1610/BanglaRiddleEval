# Qwen3:14b Reasoning Evaluation Suite

This directory contains reasoning evaluation pipeline for testing the Qwen3:14b model on Bengali riddle reasoning generation.
...
- `qwen3_14b_generative.py` - Reasoning evaluation script with LLM judge
...
# Or run directly
python qwen3_14b_generative.py
```

### Configuration

Edit the CONFIG section in `qwen3_14b_generative.py`:
...
- `riddles_reasoning_qwen3_14b_zero_shot_sample150.json` - Zero-shot results
- `riddles_reasoning_qwen3_14b_few_shot_sample150.json` - Few-shot results  
- `riddles_reasoning_qwen3_14b_chain_of_thought_sample150.json` - CoT results
- `riddles_reasoning_metrics_qwen3_14b_zero_shot_sample150.json` - Zero-shot metrics
- `riddles_reasoning_metrics_qwen3_14b_few_shot_sample150.json` - Few-shot metrics
- `riddles_reasoning_metrics_qwen3_14b_chain_of_thought_sample150.json` - CoT metrics
