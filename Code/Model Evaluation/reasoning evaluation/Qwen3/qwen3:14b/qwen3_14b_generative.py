#!/usr/bin/env python3
"""
qwen3_14b_generative.py

Reasoning evaluation pipeline for Bengali riddles using Ollama qwen3:14b model.
...
OUTPUT_ROOT = Path("/mnt/wwn-0x500a0751e14d807e-part2/Labib/Labib Folder/Labib/Research/BornoDhada/Code/Model Evaluation (Benchmark)/reasoning evaluation/Qwen3/qwen3:14b")
...
def process_generative_evaluation(ollama_llm: OllamaLLM, gemini_judge: RotatingGeminiClient, prompt_mode="zero_shot"):
    ...
    out_file = OUTPUT_ROOT / f"riddles_reasoning_deepseek_r1_7b_{prompt_mode}{suffix}.json"
    ...
    if not remaining_data:
        ...
        metrics_out = OUTPUT_ROOT / f"riddles_reasoning_metrics_deepseek_r1_7b_{prompt_mode}{suffix}.json"
...
def main():
    ...
    print("🎯 Bengali Riddle Reasoning Evaluation - Qwen3:14b")
    print("=" * 60)
