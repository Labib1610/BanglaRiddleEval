...
Reasoning evaluation pipeline for Bengali riddles using Ollama deepseek-r1:7b model.
...
OUTPUT_ROOT = Path("/mnt/wwn-0x500a0751e14d807e-part2/Labib/Labib Folder/Labib/Research/BornoDhada/Code/Model Evaluation (Benchmark)/reasoning evaluation/Deepseek-r1/deepseek-r1:7b")
