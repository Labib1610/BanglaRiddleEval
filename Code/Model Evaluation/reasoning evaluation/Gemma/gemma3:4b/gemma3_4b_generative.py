#!/usr/bin/env python3
"""
gemma3_4b_generative.py

Reasoning evaluation pipeline for Bengali riddles using Ollama gemma3:4b model.
...
OUTPUT_ROOT = Path("/mnt/wwn-0x500a0751e14d807e-part2/Labib/Labib Folder/Labib/Research/BornoDhada/Code/Model Evaluation (Benchmark)/reasoning evaluation/Gemma/gemma3:4b")
...
def process_generative_evaluation(ollama_llm: OllamaLLM, gemini_judge: RotatingGeminiClient, prompt_mode="zero_shot"):
    ...
    out_file = OUTPUT_ROOT / f"riddles_reasoning_gemma3_4b_{prompt_mode}{suffix}.json"
    ...
    if not remaining_data:
        ...
        metrics_out = OUTPUT_ROOT / f"riddles_reasoning_metrics_gemma3_4b_{prompt_mode}{suffix}.json"
