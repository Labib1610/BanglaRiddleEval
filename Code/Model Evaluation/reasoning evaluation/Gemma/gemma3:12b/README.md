# Gemma3:12b Reasoning Evaluation Suite

This directory contains reasoning evaluation pipeline for testing the Gemma3:12b model on Bengali riddle reasoning generation.
...
- `gemma3_12b_generative.py` - Reasoning evaluation script with LLM judge
...
**Important**: Add your Google Gemini API keys to the `KEY_LIST` in `gemma3_12b_generative.py`:
```python
KEY_LIST = [
    "your-api-key-1",
    "your-api-key-2",
...
- `riddles_reasoning_gemma3_12b_zero_shot_full_dataset.json` - Zero-shot results
- `riddles_reasoning_gemma3_12b_few_shot_full_dataset.json` - Few-shot results  
- `riddles_reasoning_gemma3_12b_chain_of_thought_full_dataset.json` - CoT results
- `riddles_reasoning_metrics_gemma3_12b_zero_shot_full_dataset.json` - Zero-shot metrics
- `riddles_reasoning_metrics_gemma3_12b_few_shot_full_dataset.json` - Few-shot metrics
- `riddles_reasoning_metrics_gemma3_12b_chain_of_thought_full_dataset.json` - CoT metrics
