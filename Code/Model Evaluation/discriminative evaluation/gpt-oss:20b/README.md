# GPT-OSS:20b MCQ Evaluation

This directory contains the evaluation pipeline for testing the GPT-OSS:20b model on Bengali riddle multiple-choice questions.
...
- `riddles_mcq_gpt_oss_20b_zero.json` - Zero-shot results
- `riddles_mcq_gpt_oss_20b_few.json` - Few-shot results  
- `riddles_mcq_gpt_oss_20b_cot.json` - CoT results
- `riddles_mcq_metrics_gpt_oss_20b_zero.json` - Zero-shot metrics
- `riddles_mcq_metrics_gpt_oss_20b_few.json` - Few-shot metrics
- `riddles_mcq_metrics_gpt_oss_20b_cot.json` - CoT metrics
