# DeepSeek-R1:7b MCQ Evaluation

This directory contains the evaluation pipeline for testing the DeepSeek-R1:7b model on Bengali riddle multiple-choice questions.
...
- `riddles_mcq_deepseek_r1_7b_zero.json` - Zero-shot results
- `riddles_mcq_deepseek_r1_7b_few.json` - Few-shot results  
- `riddles_mcq_deepseek_r1_7b_cot.json` - CoT results
- `riddles_mcq_metrics_deepseek_r1_7b_zero.json` - Zero-shot metrics
- `riddles_mcq_metrics_deepseek_r1_7b_few.json` - Few-shot metrics
- `riddles_mcq_metrics_deepseek_r1_7b_cot.json` - CoT metrics
