...
MCQ evaluation pipeline for Bengali riddles using Ollama deepseek-r1:14b model.
...
OUTPUT_ROOT = Path("/mnt/wwn-0x500a0751e14d807e-part2/Labib/Labib Folder/Labib/Research/BornoDhada/Code/Model Evaluation (Benchmark)/discriminative evaluation/Deepseek-r1/deepseek-r1:14b")
...
def process_mcq_evaluation(ollama_llm: OllamaLLM, prompt_mode="few", n_examples=None):
    ...
    out_file = OUTPUT_ROOT / f"riddles_mcq_deepseek_r1_{prompt_mode}.json"
    ...
    if not examples_to_process:
        ...
        metrics_out = OUTPUT_ROOT / f"riddles_mcq_metrics_deepseek_r1_{prompt_mode}.json"
