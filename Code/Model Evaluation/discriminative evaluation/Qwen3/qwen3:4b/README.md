# Qwen3:4b MCQ Evaluation

This directory contains the evaluation pipeline for testing the Qwen3:4b model on Bengali riddle multiple-choice questions.
...
- `riddles_mcq_qwen3_4b_zero.json` - Zero-shot results
- `riddles_mcq_qwen3_4b_few.json` - Few-shot results  
- `riddles_mcq_qwen3_4b_cot.json` - CoT results
- `riddles_mcq_metrics_qwen3_4b_zero.json` - Zero-shot metrics
- `riddles_mcq_metrics_qwen3_4b_few.json` - Few-shot metrics
- `riddles_mcq_metrics_qwen3_4b_cot.json` - CoT metrics
