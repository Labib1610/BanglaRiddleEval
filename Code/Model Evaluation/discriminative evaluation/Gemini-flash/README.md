# Gemini 2.5 Flash MCQ Evaluation

This directory contains the evaluation pipeline for testing the Google Gemini 2.5 Flash model on Bengali riddle multiple-choice questions using the Google Gemini API.
...
- `riddles_mcq_gemini_flash_zero_shot.json` - Zero-shot results (full dataset)
- `riddles_mcq_gemini_flash_few_shot.json` - Few-shot results (full dataset)
- `riddles_mcq_gemini_flash_chain_of_thought.json` - CoT results (full dataset)
- `riddles_mcq_metrics_gemini_flash_zero_shot.json` - Zero-shot metrics
- `riddles_mcq_metrics_gemini_flash_few_shot.json` - Few-shot metrics
- `riddles_mcq_metrics_gemini_flash_chain_of_thought.json` - CoT metrics
