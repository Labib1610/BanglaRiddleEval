# Gemma3:12b MCQ Evaluation

This directory contains the evaluation pipeline for testing the Gemma3:12b model on Bengali riddle multiple-choice questions.
...
- `riddles_mcq_gemma3_12b_zero.json` - Zero-shot results
- `riddles_mcq_gemma3_12b_few.json` - Few-shot results  
- `riddles_mcq_gemma3_12b_cot.json` - CoT results
- `riddles_mcq_metrics_gemma3_12b_zero.json` - Zero-shot metrics
- `riddles_mcq_metrics_gemma3_12b_few.json` - Few-shot metrics
- `riddles_mcq_metrics_gemma3_12b_cot.json` - CoT metrics
