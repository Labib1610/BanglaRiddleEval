# Gemma 3:4b Generative Evaluation

This directory contains the generative evaluation pipeline for testing the Gemma 3:4b model on Bengali riddle answer generation.
...
- `gemma3_4b_generative.py` - Main generative evaluation script with LLM judge
...
- `riddles_generative_gemma3_4b_zero_shot.json` - Zero-shot results (full dataset)
- `riddles_generative_gemma3_4b_few_shot.json` - Few-shot results (full dataset)
- `riddles_generative_gemma3_4b_chain_of_thought.json` - CoT results (full dataset)
- `riddles_generative_metrics_gemma3_4b_zero_shot.json` - Zero-shot metrics
- `riddles_generative_metrics_gemma3_4b_few_shot.json` - Few-shot metrics
- `riddles_generative_metrics_gemma3_4b_chain_of_thought.json` - CoT metrics
