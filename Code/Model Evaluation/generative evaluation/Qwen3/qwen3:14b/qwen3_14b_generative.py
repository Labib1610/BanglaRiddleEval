...
Generative evaluation pipeline for Bengali riddles using Ollama qwen3:14b model.
...
OUTPUT_ROOT = Path("/mnt/wwn-0x500a0751e14d807e-part2/Labib/Labib Folder/Labib/Research/BornoDhada/Code/Model Evaluation (Benchmark)/generative evaluation/Qwen3/qwen3:14b")
...
def process_generative_evaluation(ollama_llm: OllamaLLM, gemini_judge: RotatingGeminiClient, prompt_mode="zero_shot"):
    ...
    out_file = OUTPUT_ROOT / f"riddles_generative_qwen3_14b_{prompt_mode}.json"
    ...
    if not remaining_data:
        ...
        metrics_out = OUTPUT_ROOT / f"riddles_generative_metrics_qwen3_14b_{prompt_mode}.json"
...
def main():
    ...
    print("🎯 Bengali Riddle Generative Evaluation - Qwen3:14b")
    print("=" * 60)
