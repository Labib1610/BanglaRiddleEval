# GPT-OSS:20b Generative Evaluation

This directory contains the generative evaluation pipeline for testing the GPT-OSS:20b model on Bengali riddle answer generation.
...
- `gpt_oss_20b_generative.py` - Main generative evaluation script with LLM judge
...
- `riddles_generative_gpt_oss_20b_zero_shot.json` - Zero-shot results (full dataset)
- `riddles_generative_gpt_oss_20b_few_shot.json` - Few-shot results (full dataset)
- `riddles_generative_gpt_oss_20b_chain_of_thought.json` - CoT results (full dataset)
- `riddles_generative_metrics_gpt_oss_20b_zero_shot.json` - Zero-shot metrics
- `riddles_generative_metrics_gpt_oss_20b_few_shot.json` - Few-shot metrics
- `riddles_generative_metrics_gpt_oss_20b_chain_of_thought.json` - CoT metrics
