...
Generative evaluation pipeline for Bengali riddles using Ollama deepseek-r1:14b model.
...
OUTPUT_ROOT = Path("/mnt/wwn-0x500a0751e14d807e-part2/Labib/Labib Folder/Labib/Research/BornoDhada/Code/Model Evaluation (Benchmark)/generative evaluation/Deepseek-r1/deepseek-r1:14b")
...
def process_generative_evaluation(ollama_llm: OllamaLLM, gemini_judge: RotatingGeminiClient, prompt_mode="zero_shot"):
    ...
    out_file = OUTPUT_ROOT / f"riddles_generative_deepseek_r1_14b_{prompt_mode}.json"
    ...
    if not remaining_data:
        ...
        metrics_out = OUTPUT_ROOT / f"riddles_generative_metrics_deepseek_r1_14b_{prompt_mode}.json"
    ...
    for item in tqdm(remaining_data, desc=f"Generative Evaluation ({prompt_mode})"):
        ...
        bert_precision, bert_recall, bert_f1 = compute_bert_score(predicted_answer, ground_truth)
...
def main():
    ...
    print("🎯 Bengali Riddle Generative Evaluation - DeepSeek-R1:14b")
    print("=" * 60)
